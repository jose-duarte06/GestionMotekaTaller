...
export default function Ordenes() {
  ...
  const fetchMecanicos = async () => {
    // solo la pedimos si el usuario puede ver mecánicos
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/api/ordenes', {
        ...
        observaciones,
        mecanico_id: mecanicoId ? parseInt(mecanicoId) : null, // se va al backend
      });
    ...
    <div>
      ...
      <div style={{ background: 'white', padding: '2rem', borderRadius: '8px', marginTop: '1rem' }}>
        ...
        >
          ...
          {/* SOLO gerente/encargado pueden asignar mecánico al crear la orden */}
        ...
        >
          ...
          <div>
            ...
            <button onClick={() => handleExportar('pdf')} style={{ padding: '0.5rem 1rem' }}>
              PDF
            </button>
          </div>
        </div>
