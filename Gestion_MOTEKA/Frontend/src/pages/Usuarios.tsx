...
type UsuarioRow = {
    ...
    // control de acceso
    const autorizado = hasRole('gerente'); // más adelante: 'gerente','admin'
    ...
    async function cargarUsuarios() {
        ...
        try {
            ...
            const msg = err?.response?.data?.error || 'No se pudo cargar usuarios';
            setErrorLista(msg);
        } finally {
    ...
    async function crearUsuario(e: React.FormEvent) {
        ...
        setOkCrear(`Usuario '${data.usuario?.usuario ?? usuario}' creado exitosamente`);
        setUsuario('');
        setCorreo('');
        setContrasena('');
        setRol('mecanico');
    ...
    if (!autorizado) {
        ...
        <div className="usuarios-wrapper">
            ...
            <div className="usuarios-error">No estás autorizado para ver esta sección.</div>
            </div>
        </div>
        );
    }
    ...
    return (
        ...
        <div className="usuarios-card">
            ...
            Solo el gerente puede registrar personal nuevo del taller y asignarles rol.
            </p>
            ...
            <div className="usuarios-field">
                ...
                Nombre del empleado (obligatorio si es mecánico o personal nuevo)
                </label>
                <input
                className="usuarios-input"
            ...
            <button className="usuarios-boton" type="submit" disabled={creando}>
        ...
        <div className="usuarios-card">
            ...
            {cargandoLista && <div className="usuarios-info">Cargando usuarios…</div>}
            {errorLista && <div className="usuarios-error">{errorLista}</div>}
            ...
            <table className="usuarios-tabla">
                ...
                {usuarios.length === 0 ? (
                    <tr>
                    <td colSpan={6} className="usuarios-vacio">No hay usuarios</td>
                    </tr>
                ) : (
                    usuarios.map(u => (
                    <tr key={u.id}>
